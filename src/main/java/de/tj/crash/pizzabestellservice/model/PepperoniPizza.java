...
/**
 * Jede Pepperoni-Pizza ist auch zugleich eine Grundpizza - nur mit mehr
 * Zutaten!
 *
 */
public class PepperoniPizza extends BasePizza {
	...
	public PepperoniPizza(String name, double price) {
		super(name, price); // auf jeden Fall immer als erstes super(); das ist der Konstruktor der
							// BasePizza
		addToppingsForPeperroni();
	}

	public PepperoniPizza() {
		super();// auf jeden Fall immer als erstes super(); das ist der Konstruktor der
				// BasePizza
	...
	private void addToppingsForPeperroni() {
		addTopping(Toppings.PEPPERONI); // addToppings ist eine Methode der BasisPizza. Kann hier aufgerufen werden,
										// weil alle Methoden vererbt werden!
